...
imagen_fondo = pygame.image.load("images/locations/set_bg_01/forest/all.png").convert()
...
plataform_list.append(Plataform(x=600,y=430,width=50,height=50,type=3))
plataform_list.append(Plataform(x=700,y=360,width=50,height=50,type=4))
plataform_list.append(Plataform(x=750,y=360,width=50,height=50,type=5))
